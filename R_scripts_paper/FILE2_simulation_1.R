...
p1_g0 <- ggplot(data=data.frame(dataset,Cluster=as.factor(G0)), aes(x=Var1,y=Var2,col=Cluster)) + geom_point() + theme_light() + xlab("") + ylab("")
...
# MAE_miscl[1] <- mean(abs(MisclGibbs_pr - MisclO_pr))

data_plot <- rbind(data.frame(dataset, Misclassification=MisclO_pr, Type="Oracle"),
                   data.frame(dataset, Misclassification=MisclGibbs_pr, Type="Squared Euclidean"))

p1_miscl <- ggplot(data=data_plot, aes(x=Var1,y=Var2, col=Misclassification)) + geom_point(size=2) + theme_light() + xlab("") + ylab("")+ scale_color_distiller(palette="Spectral",direction=-1, limits=c(0,.75)) + facet_grid(.~Type)
...
#hist(c(SO[lower.tri(SO)] - SGibbs[lower.tri(SGibbs)]))
#summary(c(SO[lower.tri(SO)] - SGibbs[lower.tri(SGibbs)]))
...
p1_co <- ggplot(data=data_plot, aes(x=Var1,y=Var2,fill=Probability)) + geom_tile()+ scale_fill_distiller(palette="Blues",direction=1) + xlab("") + ylab("") + theme_light()+ facet_grid(.~Type)

# Horizontal Bounds -------------------------------

Credible <- credibleball(t(fit$cluster), fit_gibbs$G,alpha = 0.05, c.dist = "VI")

data_plot <- rbind(data.frame(dataset, Cluster = as.factor(Credible$c.star), Type="Maximum a posteriori"),
                   data.frame(dataset, Cluster = as.factor(Credible$c.horiz), Type="Horizontal bound"))

p1_hb <- ggplot(data=data_plot, aes(x=Var1,y=Var2,col=Cluster)) + geom_point(size=2) + theme_light() +xlab("") + ylab("") + facet_grid(.~Type)
...
p2_g0 <- ggplot(data=data.frame(dataset,Cluster=as.factor(G0)), aes(x=Var1,y=Var2)) + geom_point() + theme_light() + xlab("") + ylab("")
...
# MAE_miscl[2] <- mean(abs(MisclGibbs_pr - MisclO_pr))

data_plot <- rbind(data.frame(dataset, Misclassification=MisclO_pr, Type="Oracle"),
                   data.frame(dataset, Misclassification=MisclGibbs_pr, Type="Squared Euclidean"))

p2_miscl <- ggplot(data=data_plot, aes(x=Var1,y=Var2, col=Misclassification)) + geom_point(size=2) + theme_light() + xlab("") + ylab("")+ scale_color_distiller(palette="Spectral",direction=-1, limits=c(0,.75)) + facet_grid(.~Type)
...
p2_co <- ggplot(data=data_plot, aes(x=Var1,y=Var2,fill=Probability)) + geom_tile()+ scale_fill_distiller(palette="Blues",direction=1) + xlab("") + ylab("") + theme_light()+ facet_grid(.~Type)
...
# table(Credible$c.star,Credible$c.horiz)
levels(Credible$c.horiz)[c(3,1,4,2)] <- c(1,2,3,4)

data_plot <- rbind(data.frame(dataset, Cluster = Credible$c.star, Type="Maximum a posteriori"),
                   data.frame(dataset, Cluster = Credible$c.horiz, Type="Horizontal bound"))

p2_hb <- ggplot(data=data_plot, aes(x=Var1,y=Var2,col=Cluster,shape=Cluster)) + geom_point(size=2) + theme_light() +xlab("") + ylab("") + facet_grid(.~Type)
...
p3_g0 <- ggplot(data=data.frame(dataset,Cluster=as.factor(G0)), aes(x=Var1,y=Var2,col=Cluster)) + geom_point() + theme_light() + xlab("") + ylab("")
...
# MAE_miscl[3] <- mean(abs(MisclGibbs_pr - MisclO_pr))

data_plot <- rbind(data.frame(dataset, Misclassification=MisclO_pr, Type="Oracle"),
                   data.frame(dataset, Misclassification=MisclGibbs_pr, Type="Squared Euclidean"))

p3_miscl <- ggplot(data=data_plot, aes(x=Var1,y=Var2, col=Misclassification)) + geom_point(size=2) + theme_light() + xlab("") + ylab("")+ scale_color_distiller(palette="Spectral",direction=-1, limits=c(0,.75)) + facet_grid(.~Type)
...
p3_co <- ggplot(data=data_plot, aes(x=Var1,y=Var2,fill=Probability)) + geom_tile()+ scale_fill_distiller(palette="Blues",direction=1) + xlab("") + ylab("") + theme_light()+ facet_grid(.~Type)
...
p3_hb <- ggplot(data=data_plot, aes(x=Var1,y=Var2,col=Cluster)) + geom_point(size=2) + theme_light() +xlab("") + ylab("") + facet_grid(.~Type)
